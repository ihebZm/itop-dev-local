<?php
//
// File generated by ... on the 2023-07-21T15:58:22+0200
...
class Attachment extends DBObject
{
  ...
  array (
    0 => 'item_org_id',
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("type_attachment", array("allowed_values"=>null, "sql"=>'type_attachment', "default_value"=>'attachment_unknown', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("num_journal", array("allowed_values"=>null, "sql"=>'num_journal', "default_value"=>null, "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDateTime("date_comptabilisation", array("allowed_values"=>null, "sql"=>'date_comptabilisation', "default_value"=>null, "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("num_piece", array("allowed_values"=>null, "sql"=>'num_piece', "default_value"=>null, "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
