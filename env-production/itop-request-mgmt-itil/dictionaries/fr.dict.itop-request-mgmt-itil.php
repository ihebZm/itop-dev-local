...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	// add attribute type person vente in portal -->
	...
	// add attribute numero first invoice vente in portal -->
	...
	//add attribute numero last invoice vente in portal -->
	...
	// add attribute numero last month vente in portal -->
	...
	//add attribute chiffre d'affaires vente in portal -->
	...
	// add attribute bordereau bancaire vente in portal -->
	...
	'Class:UserRequest/Attribute:bank_slip_vente/Value:no' => 'Oui',
	'Class:UserRequest/Attribute:bank_slip_vente/Value:no+' => '',
	
	// add attribute avis d'opérations vente in portal -->
	...
	'Class:UserRequest/Attribute:transaction_notice_vente/Value:no' => 'Oui',
	'Class:UserRequest/Attribute:transaction_notice_vente/Value:no+' => '',
	
	// add attribute certificats de RS clients vente in portal -->
	...
	'Class:UserRequest/Attribute:sr_certificates_vente/Value:no' => 'Oui',
	'Class:UserRequest/Attribute:sr_certificates_vente/Value:no+' => '',
	
	// add attribute facture achat in portal -->
	...
	// add attribute statement and documents facture banque in portal -->
	...
	// add attribute comment on reconciliation statement facture banque in portal -->
	'Class:UserRequest/Attribute:comment_on_reconciliation_statement_banque' => 'commenter l\'état de rapprochement du mois précédent dûment',
	'Class:UserRequest/Attribute:comment_on_reconciliation_statement_banque+' => '',
	
	// add attribute exceptional order courrier (Visa) in portal -->
	...
	// add attribute month courrier in portal -->
	...
	// add attribute to block client URL in portal -->
